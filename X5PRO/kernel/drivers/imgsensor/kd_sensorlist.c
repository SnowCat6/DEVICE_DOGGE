...
// SnowCat
if (true){
	unsigned int nThisSelect = (pDrvIndex[1] & KDIMGSENSOR_DUAL_MASK_MSB) >> KDIMGSENSOR_DUAL_SHIFT;

	if (nThisSelect & DUAL_CAMERA_SUB_SENSOR)
		pDrvIndex[1]	= 1 | (DUAL_CAMERA_SUB_SENSOR << KDIMGSENSOR_DUAL_SHIFT);
}
